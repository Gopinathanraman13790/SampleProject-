...
//		s.selectByVisibleText("London");
		...
		WebElement SeMonth=driver.findElement(By.id("cc_exp_month"));
		Select s7=new Select(SeMonth);
		s7.selectByIndex(3);
		
		WebElement SeYear=driver.findElement(By.id("cc_exp_year"));
		Select s8=new Select(SeYear);
		s8.selectByIndex(3);
		
		WebElement Ccvnumber=driver.findElement(By.id("cc_cvv"));
		Ccvnumber.sendKeys("789");
		
		
		WebElement Btn3=driver.findElement(By.id("book_now"));
		Btn3.click();
		Thread.sleep(1000);
		WebElement Ordervnumber=driver.findElement(By.id("order_no"));
		Thread.sleep(4000);
		String name=Ordervnumber.getAttribute("value");
